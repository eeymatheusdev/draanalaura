  ...
  const services = [
    {
      icon: Smile,
      title: "Clínica Geral",
      description: "Atendimento odontológico completo com foco em prevenção e tratamento de problemas bucais.",
      treatments: [
    ...
    },
    {
      ...
      description: "Procedimentos estéticos faciais para realçar sua beleza natural com segurança e precisão.",
      treatments: [
    ...
    <section id="services" className="py-20 px-4 bg-card">
      <div className="container mx-auto max-w-6xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Oferecemos tratamentos personalizados para cuidar do seu sorriso e realçar sua beleza natural
        </p>
